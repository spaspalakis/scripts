...
if __name__ == '__main__' :
    ...
    input = '/home/spaspalakis/Desktop/certh/Callisto/Dataset/Callisto_dataset_v2/callisto_train'
    # ap.add_argument("-i", "--input", required=True, help="Xmls path")
    output = '/home/spaspalakis/Desktop/certh/Callisto/Dataset/Callisto_dataset_v2/yolo'
    # ap.add_argument("-o", "--output", required=True, help="output directory ")
    # args = vars(ap.parse_args())   

    # # Create output path if not already exists
    # if not os.path.exists(args["output"]):
    #    os.makedirs(args["output"])s
