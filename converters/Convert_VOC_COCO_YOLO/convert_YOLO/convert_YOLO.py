...
classes = ['bridge', 'crossroad', 'T_junction', 'parking_lot', 'building'] #['person', 'motorcycle', 'car', 'truck', 'bicycle', 'bus']
...
full_dir_path =  Path(r'/home/spaspalakis/Desktop/certh/Callisto/Dataset/Callisto_dataset_v2/train') #Path(r'/home/stayros/Desktop/annot_xml/')
output_path = Path(r'/home/spaspalakis/Desktop/certh/Callisto/Dataset/Callisto_dataset_v2/callisto_train_YOLO_format') #Path(r'/home/stayros/Desktop/annot_txt2/')
