...
FOLDER_DIR = '/home/stayros/Desktop/isola-research/all_test-5.0/dtset' #'/home/stayros/Desktop/sea_drones_val_xml/set2/set2-rembg' #'/home/stayros/Desktop/isola-research/uav123/boat6/boat6-rembg' #/home/stayros/Desktop/isola-research/all_test-5.0/dtset' # # #
CROP_DIR_FOLDER = '/home/stayros/Desktop/isola-research/all_test-5.0/cropped' #'/home/stayros/Desktop/sea_drones_val_xml/set2/set2-cropped' #'/home/stayros/Desktop/isola-research/uav123/boat6/boat6-cropped' #'/home/stayros/Desktop/isola-research/all_test-5.0/cropped' # # #
PAD_DIR_FOLDER = '/home/stayros/Desktop/isola-research/all_test-5.0/padded'#'/home/stayros/Desktop/sea_drones_val_xml/set2/set2-padded' #'/home/stayros/Desktop/isola-research/uav123/boat6/boat6-padded' #'/home/stayros/Desktop/isola-research/all_test-5.0/padded' # # #
FUSED_DIR_FOLDER = '/home/stayros/Desktop/isola-research/all_test-5.0/fused' #'/home/stayros/Desktop/sea_drones_val_xml/set2/set2-fused' #'/home/stayros/Desktop/isola-research/uav123/boat6/boat6-fused' #'/home/stayros/Desktop/isola-research/all_test-5.0/fused' # # #
...
def get_arguments():
    ...
    parser.add_argument('--use-max-padding', action='store_true',
...
if __name__ == '__main__':
    ...
    # scale_list = [scale_x1,scale_x2,scale_y1,scale_y2]
    ...
    for file in  sorted_files: 
        ...
        if file.endswith(".jpg"):   
                ...
                cropped_jpg,scale_x1, scale_x2, scale_y1, scale_y2,\
                    cropped_img_w,cropped_img_h = crop_image_by_percentage(jpg_img, percent,\
                ...
                row1 = [cropped_img_w , file_name] 
                crop_width_list.append(row1)
                
                row2 = [cropped_img_h , file_name] 
                crop_height_list.append(row2)
                ...
                cropped_png,scale_x1, scale_x2, scale_y1, scale_y2,cropped_img_w,cropped_img_h  = crop_image_by_percentage(png_img, percent,green_x1, green_x2, green_y1, green_y2,crop_folder,file_name,file_type)
                # print('\nRemBG image cropped')
    ...
    # print(max(scale_x2_list[0]))

    print('\n-------\nMax Width and Max Height in cropped folder:')
    
    max_crop_w = max(row[0] for row in crop_width_list) 
    max_crop_h = max(row[0] for row in crop_height_list)
    print('max_crop_w ',max_crop_w)
    print('max_crop_h ', max_crop_h)
    ...
    if add_padding_flag:
        ...
        if use_max_padding:
            ...
            new_width = max_crop_w  # Desired width of the padded image
            new_height = max_crop_h  # Desired height of the padded image    
